...
BASE_URL = os.environ.get("REACT_APP_BACKEND_URL", "https://space-transformed.preview.emergentagent.com").rstrip("/")
...
class TestCheckout:
    ...
    def test_checkout_session_creates(self, api):
        r = api.post(
            ...
            json={
                "package_id": "standard",
                "origin_url": "https://space-transformed.preview.emergentagent.com",
