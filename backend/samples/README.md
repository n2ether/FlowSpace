...
| `before` | Last-page **Before** — customer original photo. |
| `after` | Last-page **After** — FLUX organized render. Never invented. |
...
| `flowspace-blueprint-sample.pdf` | Current site-palette Blueprint **with** organized hero + last-page Before \| After |
